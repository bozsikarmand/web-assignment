        ...
        <div class="center">
            ...
            <div class="biography">
                <form action="../../WebAssignment/logic/register.php" class="form-register" method="post">
                    ...
                    <input name="form-register-email" placeholder="Email" required="required" type="email" />
                    <p>Select your role:</p>
                    <select title="Select your role:" required name="form-register-role" size="1">
                        <option value="" disabled>&nbsp;</option>
                        <optgroup label="Available roles" class="form-register-role-available">
